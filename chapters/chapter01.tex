...
Toinen yleinen ongelma Windowssissa on kun projektissa on kun projektin riippuvuuksia asennetaan npm:n avulla. Kun kutsutaan \code{npm install} niin npm hakee projektin riippuvuudet, sen jälkeen riippuvuuksien riippuvuudet sitten niiden riippuvuudet ja niin edelleen. Tästä aiheutuu pitkiä tiedostopolkuja. Kuviossa \ref{listing:npm-error-long-path} on esimerkki npm:n virheestä, joka sisältää pitkän tiedostopolun.
