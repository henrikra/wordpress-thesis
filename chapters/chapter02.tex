...
Ansible antaa yhteenvedon tehtävistä, kun tehtävä ovat loppuneet. Se kertoo esimerkiksi kuinka monta tehtävää ei tarvinnut suorittaa (ei muutoksia) ja kuinka monta tehtävää suoritettiin (muutoksia oli).
...
Ohje Ansiblen käytön aloittamiseksi on osoitteessa \url{http://docs.ansible.com/ansible/intro_installation.html}. Asennuksen jälkeen avaa komentorivi ja komenna \\ \code{ansible -{}-version}. Jos Ansible kertoo nykyisen versionsa, on Ansible asennettu oikein.
